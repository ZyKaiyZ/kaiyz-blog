...
![](../../assets/images/post3-p1.png)

1. 開啟後可以找想要配置的位置，我是存放在 `檔案` 的功能列中

![](../../assets/images/post3-p2.png)

3. 在想要新增的位置點選 `加入命令`

![](../../assets/images/post3-p3.png)

4. 點選左側 `檔案` 後在右側找到 `進階儲存選項`

![](../../assets/images/post3-p4.png)

5. 點選 `進階儲存選項`

![](../../assets/images/post3-p5.png)

6. 最後點選想要儲存的編碼格式就完成了

![](../../assets/images/post3-p6.png)
